...
void UIManager::applyModernDarkTheme()
{
...
)
{
    ...
    ImGui::SetNextWindowSize(ImVec2(820, 400), ImGuiCond_Always);
    m_floorView.render(snap, factory, m_selectedMachine);

    ImGui::SetNextWindowPos(ImVec2(860, 220), ImGuiCond_Always);
    ...
    ImGui::SetNextWindowSize(ImVec2(1180, 150), ImGuiCond_Always); 
